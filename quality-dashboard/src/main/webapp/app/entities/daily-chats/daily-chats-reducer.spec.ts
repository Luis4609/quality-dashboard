...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DAILYCHATS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DAILYCHATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DAILYCHATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DAILYCHATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DAILYCHATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DAILYCHATS actions', async () => {
      const expectedActions = [
        {
