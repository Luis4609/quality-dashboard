...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DAILYCALLS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DAILYCALLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DAILYCALLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DAILYCALLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DAILYCALLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DAILYCALLS actions', async () => {
      const expectedActions = [
        {
