...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_METRICTHRESHOLD_LIST actions', async () => {
    ...
    it('dispatches FETCH_METRICTHRESHOLD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_METRICTHRESHOLD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_METRICTHRESHOLD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_METRICTHRESHOLD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_METRICTHRESHOLD actions', async () => {
      const expectedActions = [
        {
